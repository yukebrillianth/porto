export const siteConfig = {
  ...
  // Generated by app/opengraph-image.tsx rather than a file in public/. An
  // earlier static path was referenced everywhere but never existed, so every
  // share rendered blank; a route cannot go missing the same way.
